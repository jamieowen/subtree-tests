  ...
  (
    ...
    const { refDeferred, refGbuffer } = useDeferredModule({
      ...
      `,
        ...
        vec2 RotationVector = vec2(cos(ALPHA), sin(ALPHA));

        // a value of 3 means a 3x3 grid, which is the equivalent of 1px thickness
        float KERNEL_SIZE = ceil(uDeferredOutline_thickness) * 2.0 + 1.0; 
